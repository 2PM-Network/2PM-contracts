...
import "./DataHub.sol";
import "./interface/ITwoPMDAO.sol";
...
contract HLR {
     ...
     */
    constructor(IdentityContract idAddr, DataHub dbAddr, address twoPMDAOAddr) {
        idContract = idAddr;
        dataContract = dbAddr;
        owner = msg.sender; // 'msg.sender' is sender of current call, contract deployer for a constructor
        // deploy TwoPMDAO contract first, then call this method to set the address
        ITwoPMDAO twoPMDAO = ITwoPMDAO(twoPMDAOAddr);
    ...
    function startRound(
        ...
        twoPMDAO.startTrainRound(taskId);
    ...
    function selectCandidates(
        ...
        for (uint256 i = 0; i < addrs.length; i++) {
            ...
            twoPMDAO.registerNode(taskID, addrs[i]);
        }
